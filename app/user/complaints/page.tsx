...
import { DashboardLayout, FilterBar, EmptyState } from '@/components/dashboard';
import {
    Home, Plus, Inbox, Clock, CheckCircle, Activity,
...
export default function UserComplaintsPage() {
    ...
    const initializePage = () => {
        ...
        try {
            ...
            if (userData.email) {
                fetchComplaints(userData.email, 1, filter);
            } else {
                setLoading(false);
            }
        } catch (error) {
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-primary-50 dark:from-gray-900 dark:via-gray-800 dark:to-primary-950 transition-colors duration-300 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Loading...</h3>
                </div>
            </div>
        );
    }
    ...
    const navItems = [
        ...
        { label: 'All Complaints', href: '/user/complaints', icon: Inbox, active: true }
    ];
    ...
    return (
        ...
        >
            {/* Header */}
            <div className="mb-6">
                <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">All Your Complaints</h1>
                <p className="text-gray-600 dark:text-gray-400">View and manage all your submitted complaints</p>
            </div>
            ...
            <FilterBar
                ...
                onReset={() => {
                    const resetFilter = { status: '', category: '', search: '' };
                    setFilter(resetFilter);
                    if (user.email) {
                        fetchComplaints(user.email, 1, resetFilter);
                    }
                }}
            />
                ...
                <div className="p-6 border-b border-gray-200 dark:border-gray-700">
                    <div className="flex items-center justify-between">
                        <h2 className="text-xl font-semibold text-gray-900 dark:text-white flex items-center">
                            <Inbox className="w-6 h-6 mr-3 text-primary-600 dark:text-primary-400" />
                            Your Complaints
                                    ...
                                    {Array.from({ length: Math.min(5, pagination.pages) }, (_, i) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`w-8 h-8 text-sm font-medium rounded-md transition-colors ${pageNum === pagination.page
